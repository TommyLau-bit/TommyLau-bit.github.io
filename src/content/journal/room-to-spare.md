...
<p class="sources">Sources: Jane Street's video tour of its latest AI data centre with the podcaster Dwarkesh Patel, published on Jane Street's YouTube channel on 15 May 2026, with Yaron Minsky and Dan Pontecorvo, for the site's GPU count, rack power, cooling design, power distribution and the engineers' descriptions of how they run it. Jane Street's own write-up of the site, which describes the new racks as using a small fraction of the space originally allotted for chips. Nvidia developer blog on GB300 NVL72 power smoothing, 2025, for the capacitor energy storage and the reduction in peak grid draw. Figures are as stated by the companies on the dates cited. Personal research, not investment advice.</p>
